...
# Pending
# generate more missingness than the original ones
...
#         
#         # Update the dataset
#         dataset[, colnames(condition_rx)] <- condition_rx
#         
...
#             }
#           }
#           subset %<>% dplyr::select(-all_of(condition_rx_vars))
...
#       }
#       
#       #---- Derive condition based on condition + med----
...
#         }
#       }
#       subset[, colnames(condi_new)] <- condi_new
#       subset %<>% dplyr::select(colnames(condi_new))
# 
#     }
#     #update hrs_samp
...
#                           hrs_samp)
# 
# test_no_rx <- chronic_condition_per_wave("mem", paste0("r", seq(5, 9), "memrye"),
#                                 NA,
#                                 hrs_samp)
# 
# #Sanity check
# for(var in c(paste0("r", seq(4, 9), "diabe_derived"), 
#              c(paste0("r", seq(4,9), "diabe")),
#              c(paste0("diabetes_rx_insulin", seq(4, 9)),
#                paste0("diabetes_rx_swallowed", seq(4, 9))))){
#   print(var)
#   print(table(test[, var], useNA = "ifany"))
...
# for(var in c(paste0("r", seq(4, 9), "hibpe_derived"),
#              paste0("bp_rx", seq(4, 9)))){
#   print(var)
#   print(table(test[, var], useNA = "ifany"))
# }
# 
# 
# for(var in paste0("r", seq(5, 9), "memrye")){
#   print(var)
#   print(table(test_no_rx[, var], useNA = "ifany"))
# }
