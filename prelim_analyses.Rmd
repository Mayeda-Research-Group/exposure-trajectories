...
p_load("here", "tidyverse", "magrittr", "knitr", "broom", "kableExtra")
...
*Neither of these sources mention race/ethnicity... should I adjust for it anyway?*

I'm thinking that we don't want a model that controls for CRP even though it's available in the HRS biomarker data.  This is likely to have just as much missing data as Cystatin C.  
