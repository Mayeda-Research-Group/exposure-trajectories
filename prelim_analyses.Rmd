...
hrs_samp_alive_70 <- 
  read_csv(here::here("Data", "hrs_samp_alive_70.csv"))
...
ggplot(hrs_samp, aes(x = num_measures)) + 
  ...
  labs(y = "Percent", x = "Number of CysC Measures for 2016 HRS Participants") +
...
Number of people: `r nrow(hrs_samp_birth_cohort)`  
Number of observations: `r sum(as.numeric(hrs_samp_birth_cohort$num_measures))`  
Percent mortality: `r round(mean(hrs_samp_birth_cohort$death)*100, 2)`% 

**Based on survival through age 70**  
Number of people: `r nrow(hrs_samp_alive_70)`  
Number of observations: `r sum(as.numeric(hrs_samp_alive_70$num_measures))`  
Percent mortality: `r round(mean(hrs_samp_alive_70$death)*100, 2)`%
...
```{r age summary stat plots 2014 Survivors}
subsets <- list("'Participated' in 2016 HRS" = hrs_samp, 
                "1931-1941 birth cohort" = hrs_samp_birth_cohort,
                "Survival to 70" = hrs_samp_alive_70)
...
```{r age summary stat plots 2014 Zombie people}
subsets <- list("'Participated' in 2016 HRS" = hrs_samp, 
                "1931-1941 birth cohort" = hrs_samp_birth_cohort,
                "Survival to 70" = hrs_samp_alive_70)
...
```
```{r age summary stat plots 2016 Survivors}
subsets <- list("'Participated' in 2016 HRS" = hrs_samp, 
                "1931-1941 birth cohort" = hrs_samp_birth_cohort,
                "Survival to 70" = hrs_samp_alive_70)
...
```{r age summary stat plots 2016 Zombie people}
subsets <- list("'Participated' in 2016 HRS" = hrs_samp, 
                "1931-1941 birth cohort" = hrs_samp_birth_cohort,
                "Survival to 70" = hrs_samp_alive_70)
