...
array=(673 1501 2158 3184 3454 4030 5191 5848 6145 7063 7216 8197 8305 8440 8746 8944)
...
# run R code
echo "R CMD BATCH --no-save --no-restore "--args mechanism=\"MNAR\" method=\"FCS\" mask_percent=\"10%\" seed=$seed save=\"no\" sens=\"no\" "  mask_impute_pool.R output/output.$JOB_ID.$SGE_TASK_ID"
R CMD BATCH --no-save --no-restore "--args mechanism=\"MNAR\" method=\"FCS\" mask_percent=\"10%\" seed=$seed save=\"no\" sens=\"no\" "  mask_impute_pool.R output/output.$JOB_ID.$SGE_TASK_ID
