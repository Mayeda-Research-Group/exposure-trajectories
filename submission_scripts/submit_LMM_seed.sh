...
R CMD BATCH --no-save --no-restore '--args mechanism="MAR" method="LMM" mask_percent="30%" seed=123 save="no" sens="no" '  mask_impute_pool.R output/output.$JOB_ID.$SGE_TASK_ID
